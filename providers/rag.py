...
path ="C:/Users/peppe/Desktop/Progetti/DIMAROLANGCHAIN/downloaded_movie"
...
class RAGProvider:
    ...
    def create_index(
            ...
            input_files: List[str] = [path+"/movies.json"]
    ):
    ...
    def query_llm(
        ...
        logging.info(f"Formatted prompt: {formatted_prompt}")
        #response = query_engine.query(formatted_prompt)
        movie_list = self.llm.complete(str(prompt))
